...
export default function Navbar() {
  ...
  return (
    ...
    <nav className="fixed bottom-4 left-4 right-4 z-50 lg:hidden bg-dark-950/55 backdrop-blur-2xl backdrop-saturate-150 rounded-full border border-white/10 shadow-lg shadow-black/40 pb-[env(safe-area-inset-bottom)]">
